...
insert into book values(2,'경재',1,9000,'2021-04-11');
insert into book values(3,'경재',2,11000,'2021-02-05');
...
select book_id as 도서_id, published_date as 출판일 from book where category = '인문' and
to_char(published_date,'YYYY') = '2021'
order by published_date asc;

select b.book_id as 도서_id, a.author_name as 저자명 , b.published_date as 출판일 from book b, author a where b.author_id=a.author_id and b.category = '경재'
order by published_date asc;